  ...
  ngOnInit() {
    ...
    this.route.params.subscribe(params => {
      ...
      then( response => { this.product = response;
        ...
        this.parentId = this.product.category.parentId;
        this.onChange(this.parentId)
  ...
  Add(value){
    ...
    if(this.updateFlag === false){
      ...
      this.productService.AddProduct(value).
                then( responseAdsresult => { this.productresults = responseAdsresult;
                  setTimeout(() => {
                    this.spinner.hide();
                  }, this.productresults);
                });
...
onChange(parentId){
  let type = "products"
  this.categoryService.GetSubCategories(type,parentId).
  then( responsedata => { 
